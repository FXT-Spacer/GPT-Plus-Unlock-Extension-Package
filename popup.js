async function sendMessage() {
    ...
    chrome.runtime.sendMessage({
        ...
        if (response.message === '1') {
            ...
            alert('Unlock failed, the server\'s unlock key has expired, please wait for the unlock key to be updated or visit https://gpf-openfxt.vercel.app/ to get a free backup GPT Plus account. Thank you for your interest and use of OpenFXT\'s services.')
        } else {
