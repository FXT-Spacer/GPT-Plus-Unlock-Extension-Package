chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
    if (message.type == 'unlock') {
        ...
        function refetchurl() {
            fetch('https://gpf-openfxt.vercel.app/unlock_key_source/second_source.txt', { cache: 'no-cache' })
        ...
        fetch('https://gpf-openfxt.vercel.app/unlock_key_source/first_source.txt', { cache: 'no-cache' })
            .then(response => response.text())
            .then(data => {
                dataObj = extractAndPrintInfo(data)
                fetch(dataObj.url, {
